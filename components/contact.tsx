    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 font-poppins">Get in Touch</h2>
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-teal-500 to-blue-600 text-white hover:from-teal-600 hover:to-blue-700"
              >
                Submit Request
              </Button>
            </form>
